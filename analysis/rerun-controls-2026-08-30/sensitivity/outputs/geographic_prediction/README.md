...
- Supported: **False**
- Equal-weight cross-validated R2: -0.0016
- Pooled cross-validated R2: -0.0004
- Folds with positive skill: 10/18
- Strictest null p value: 0.36
...
- Supported: **True**
- Out-of-block R2: 0.2473
- Blocks with positive skill: 6/6
- Strictest null p value: 0.03333
...
The primary test holds out a whole campaign and a contiguous transect block together and scores within-compartment differences between held-out sites. It did not support cross-campaign, cross-block transport of the transect gradient (equal-weight R2 -0.0016, pooled -0.0004, 10/18 folds positive, strictest null p = 0.36). As a sensitivity, holding out a contiguous site block alone while keeping the same campaigns on both sides of the split did predict the site-averaged composition of the held-out block (out-of-block R2 0.2473, 6/6 blocks positive, strictest null p = 0.03333). This sensitivity does not hold out a campaign and therefore does not demonstrate transport to an unseen campaign.
