...
extraction, whole-cell standards do, Trips~$1$--$3$ had no usable
extraction blank (although co-prepared profiles were no more similar than
distance-matched pairs; Supplementary Section~S2), Trip~$4$ had no field-based positive
...
batch and no usable sequenced blank, so no extraction blank could be linked
to their profiles (Supplementary Section~S2).
